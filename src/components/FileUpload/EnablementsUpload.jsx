...
const EnablementsUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('archivoKilometraje', file);

      console.log('Enviando archivo:', file.name, 'tipo:', file.type);

      const response = await fetch('https://74pbcspn-3020.use2.devtunnels.ms/api/archivos/subir-kilometraje', {
        method: 'POST',
        headers: {
    ...
    <div className="upload-section">
      ...
      <form onSubmit={handleSubmit}>
        <div className="file-input-container">
          ...
          />
          <label htmlFor="enablements-file" className="file-label">
...
export default EnablementsUpload; 