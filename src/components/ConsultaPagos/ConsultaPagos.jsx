...
export const ConsultaPagos = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://74pbcspn-3002.use2.devtunnels.ms/PagosOperario",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <Navar />
      <div className="ContainerConsultaPagos">
        ...
        <main className="contentWrapper">
          ...
          <section className="Container_Titles_pagos">
            ...
            <div className="container_Cant-Consulta">
              <h4 className="avisoCantidad">
                Cantidad de consulta en ejecución :
              </h4>
              <h2 className="containe-contadorPeticiones">
                {requestCounter}/{maxConcurrentRequests}
              </h2>
              <h4 className="avisoCantidad">
                Por favor espere un turno... lo permitido son 3 consultas máximo.
              </h4>
            </div>
          </section>
